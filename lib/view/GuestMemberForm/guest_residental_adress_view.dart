...
class _PesidentalAdressViewState extends State<PesidentalAdressView> {
  ...
  void _performPincodeSearch(String pincode, RegisterController controller) {
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                ...
                                if (value.length == 6) {
                                  // This will trigger the listener we added in initState
                                }
                              },
                            ),
                          ),
                                            ...
                                            return Expanded(
                                              child: InputDecorator(
                                                ...
                                                child: DropdownButton<String>(
                                                  ...
                                                  items: regiController.countryList.map((country) {
                                            ...
                                            return Expanded(
                                              child: InputDecorator(
                                                ...
                                                child: DropdownButton<String>(
                                                  ...
                                                  items: regiController.stateList.map((state) {
                                                    return DropdownMenuItem<String>(
                                            ...
                                            return Expanded(
                                              child: InputDecorator(
                                                ...
                                                child: DropdownButton<String>(
                                                  ...
                                                  items: regiController.cityList.map((city) {
                                                    return DropdownMenuItem<String>(
                                  ...
                                  return Expanded(
                                    child: InputDecorator(
                                      ...
                                      child: DropdownButton<String>(
                                        ...
                                        items: regiController.memberShipList.map((ms) {
                                          return DropdownMenuItem<String>(
                                    ...
                                    return Expanded(
                                      child: InputDecorator(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          items: regiController.documntTypeList.map((doc) {
                                            return DropdownMenuItem<String>(
