...
class FamilyDetailYourself extends StatefulWidget {
  ...
  const FamilyDetailYourself({
    Key? key,
    required this.shikshaApplicantId,
  }) : super(key: key);

  @override
  State<FamilyDetailYourself> createState() => _FamilyDetailYourselfState();
}

class _FamilyDetailYourselfState extends State<FamilyDetailYourself> {
  ...
  Widget _buildFamilyList() {
    ...
    // ✅ Add Family Head only if not logged-in member
    if (controller.familyHeadData.value != null &&
        controller.familyHeadData.value!.memberId != currentMemberId) {
