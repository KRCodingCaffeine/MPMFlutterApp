...
class CurrentYearEducationYourselfView extends StatefulWidget {
  final String shikshaApplicantId;

  const CurrentYearEducationYourselfView({
    Key? key,
    required this.shikshaApplicantId,
  }) : super(key: key);

  @override
  State<CurrentYearEducationYourselfView> createState() =>
      _CurrentYearEducationYourselfViewState();
}

class _CurrentYearEducationYourselfViewState extends State<CurrentYearEducationYourselfView> {
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await prefs.setBool('current_year_completed_yourself', true);
