...
class PreviousYearLoanYourselfView extends StatefulWidget {
  final String shikshaApplicantId;

  const PreviousYearLoanYourselfView({
    Key? key,
    required this.shikshaApplicantId,
  }) : super(key: key);

  @override
  State<PreviousYearLoanYourselfView> createState() => _PreviousYearLoanYourselfViewState();
}

class _PreviousYearLoanYourselfViewState extends State<PreviousYearLoanYourselfView> {
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // 🔥 Use Yourself Key
                await prefs.setBool('previous_loan_completed_yourself', true);

                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (_) => ReferenceYourselfView(
                      shikshaApplicantId: widget.shikshaApplicantId,
                    ),
                  ),
                );
