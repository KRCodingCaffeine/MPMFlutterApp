...
class EditFamilyDetailView extends StatefulWidget {
  final ShikshaApplicationsByAppliedByData applicationData;

  const EditFamilyDetailView({
    Key? key,
    required this.applicationData,
  }) : super(key: key);

  @override
  State<EditFamilyDetailView> createState() => _EditFamilyDetailViewState();
}

class _EditFamilyDetailViewState extends State<EditFamilyDetailView> {
                            ...
                            ElevatedButton(
                              onPressed: _isFormValid()
                                ...
                                try {
                                  ...
                                  final body = {
                                    "shiksha_applicant_id": widget.applicationData.shikshaApplicantId,
