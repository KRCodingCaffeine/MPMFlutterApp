...
class EditPreviousYearLoanView extends StatefulWidget {
  final ShikshaApplicationsByAppliedByData applicationData;

  const EditPreviousYearLoanView({
    Key? key,
    required this.applicationData,
  }) : super(key: key);

  @override
  State<EditPreviousYearLoanView> createState() => _EditPreviousYearLoanViewState();
}

class _EditPreviousYearLoanViewState extends State<EditPreviousYearLoanView> {
