...
import 'package:mpm/model/EventTripModel/GetEventTrip/SamitiOrganiserData.dart';
import 'package:mpm/model/Zone/ZoneData.dart';
import 'package:mpm/utils/urls.dart';

class GetEventTripData {
  String? tripId;
  String? tripName;
  ...
  factory GetEventTripData.fromJson(Map<String, dynamic> json) {
    return GetEventTripData(
