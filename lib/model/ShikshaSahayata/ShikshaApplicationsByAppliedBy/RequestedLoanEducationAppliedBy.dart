class RequestedLoanEducationAppliedBy {
  ...
  // ✅ NEW FIELDS
  final String? totalRepaidAmount;
  ...
  factory RequestedLoanEducationAppliedBy.fromJson(
      Map<String, dynamic> json) {
    return RequestedLoanEducationAppliedBy(
      ...
      sanctionedUpdatedBy:
      json['sanctioned_updated_by']?.toString(),
      sanctionedUpdatedOn:
      json['sanctioned_updated_on']?.toString(),
      disbursedAmount: json['disbursed_amount']?.toString(),
      disbursedOn: json['disbursed_on']?.toString(),
      disbursedUpdatedBy:
      json['disbursed_updated_by']?.toString(),
      disbursedUpdatedOn:
      json['disbursed_updated_on']?.toString(),

      // ✅ NEW JSON MAPPING
      totalRepaidAmount:
      json['total_repaid_amount']?.toString(),
      outstandingBalance:
      json['outstanding_balance']?.toString(),
      loanStatus:
